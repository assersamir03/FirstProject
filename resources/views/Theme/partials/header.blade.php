    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container box_1620">
          ...
          <a class="navbar-brand logo_h" href="{{route('theme.index')}}"><img src="{{asset('asset')}}/img/logo.png" alt=""></a>
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            ...
            <!-- Add new blog -->
            <a href="{{route('theme.register')}}" class="btn btn-sm btn-primary mr-2">Add New</a>
            <!-- End - Add new blog -->
